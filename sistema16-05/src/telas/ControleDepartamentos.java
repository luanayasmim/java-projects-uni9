...
public class ControleDepartamentos extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {           
            DepartamentoDao.Salvar(txtCodigo.getText(), txtNome.getText(), txtCidade.getText(), txtTelefone.getText());
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        try {            
            DepartamentoDao.Alterar(txtCodigo.getText(), txtNome.getText(), txtCidade.getText(), txtTelefone.getText());
